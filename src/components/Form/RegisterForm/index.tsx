...
//   email: z.string().email('O email deve ser obrigatório e válido').min(1, 'O email deve ser obrigatório'),
...
//   passwordConfirmation: z.string().min(8, 'Confirme a sua senha por favor.').refine((value, data) => value === data.password, {
...
// export const RegisterForm = ({ setUsers }: IRegisterProps) => {
